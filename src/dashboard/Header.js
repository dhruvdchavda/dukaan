...
function Header() {
  return (
    <div className="bg-white flex items-center justify-between border-b-[1px] border-[#D9D9D9] max-w-[1216px] py-[12px] px-[32px] h-[64px]">
      <div className="flex items-center">
        <p className="text-[15px] mr-[16px] text-[#1A181E]">Payments</p>
        <svg
          width="14"
          height="14"
          viewBox="0 0 14 14"
        ...
        <p className="text-[12px] text-[#4D4D4D] cursor-pointer">
          {" "}
          How it works
        </p>
      </div>
      <div className="relative">
        ...
        <input
          className="bg-[#F2F2F2] ps-12 py-[9px] pe-[12px] text-[15px] w-[400px] rounded-[6px] text-[#808080] focus:outline-none"
          type="search"
          id="default-search"
      ...
      <div className="flex">
        <div className="flex justify-center items-center mr-[12px] bg-[#E6E6E6] h-[40px] w-[40px] rounded-full cursor-pointer">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
        ...
        <div className="flex justify-center items-center bg-[#E6E6E6] h-[40px] w-[40px] rounded-full cursor-pointer">
          <svg
            width="14"
            height="9"
            viewBox="0 0 14 9"
